    ...
    public void handleButtonValiderComSol (ActionEvent e) throws SQLException{
        if (data_table_sol.isEmpty()){
            ...
            if (radio384.isSelected()) {
                data_commande_att.add(new Commande(String.valueOf(1), String.valueOf(comboAgent.getValue()), LocalDate.now(), String.valueOf(Comboexp.getValue()), String.valueOf(spinnerSlot.getValue()),String.valueOf(spinnerDuree.getValue()),String.valueOf(spinnerFreq.getValue()),buttonModif,new Button("Infos"), FXCollections.observableArrayList(data_table_sol), "384",String.valueOf(comboReact.getValue()), this ));
            ...
            if (radio96.isSelected()) {           
                data_commande_att.add(new Commande(String.valueOf(1), String.valueOf(comboAgent.getValue()),LocalDate.now(), String.valueOf(Comboexp.getValue()), String.valueOf(spinnerSlot.getValue()),String.valueOf(spinnerDuree.getValue()),String.valueOf(spinnerFreq.getValue()),buttonModif,new Button("Infos"), FXCollections.observableArrayList(data_table_sol), "96", String.valueOf(comboReact.getValue()), this ));
                Pattern p = Pattern.compile("-");
                String[] items = p.split(String.valueOf(comboAgent.getValue()));           
